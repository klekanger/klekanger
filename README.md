...
I have good skills in vanilla Javascript and Node.js, HTML and CSS. However, I have focused mostly on frameworks/libraries like React.js - and React based frameworks like Gatsby.js and Next.js. I've worked mostly on the frontend, but have a good understanding of the backend - and have set up servers and APIs in Node.js (with Express) or as serverless functions in AWS Lambda or Netlify Functions. 
